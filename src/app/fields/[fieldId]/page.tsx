...
//     const controlTopic = `commands/${field.fieldId}/${currentUser.farmerId}`;
//     const message = {
//       actuator,
...
//       if (err) {
//         console.error(
//           `FieldDetailsPage: Error publishing ${actuator} ${status} command:`,
//           err
//         );
//         toast.error(`Failed to update ${actuator} status`);
//         return;
...
//       console.log(
//         `FieldDetailsPage: Published ${actuator} ${status} to ${controlTopic}`
//       );
